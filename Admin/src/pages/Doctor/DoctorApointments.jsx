  ...
  return (
    <div className="w-full max-w-6xl mx-auto p-4 md:p-6">
      ...
      <div className="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
        {/* Table Header */}
        <div className="hidden md:grid grid-cols-12 gap-4 px-6 py-4 bg-[#FF7F50] bg-opacity-5 text-gray-600 font-medium border-b">
          ...
          appointments.map((item, index) => (
            ...
            >
              ...
              <div className="col-span-3 md:col-span-2 flex justify-end items-center gap-2">
                <button className="p-2 rounded-lg hover:bg-red-50 text-red-500 hover:text-red-600 transition-colors">
